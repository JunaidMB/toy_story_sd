...
#response = requests.post('http://127.0.0.1:5000/generate_image_rest', data=json_payload, headers=headers)
#response = requests.post('http://127.0.0.1:5000/generate_image_rest_direct', data=json_payload, headers=headers)

# Interpolate NGROK link generated by the notebook - the URL below will not work
ngrok_url = "http://4c0d-35-247-178-109.ngrok.io"
